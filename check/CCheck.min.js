...
u(e.statementClasses,e.statementClasses,"extends","statementClass")})();u(e.resourceClasses,e.resources,"class","resourceClass");x(e.resourceClasses,e.resources,"class");(function(){u(e.statementClasses,e.statements,"class","statementClass");var b=e.resources.concat(e.statements),f=e.resourceClasses.concat(e.statementClasses);e.statements.forEach(function(a,c){var d=p(b,a.subject),l=p(b,a.object);!d&&0>k.dontCheck.indexOf("statement.subject")&&g.push({status:980,statusText:"subject of statement["+
