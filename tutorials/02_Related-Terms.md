...
You may also view/download the example [Related Terms](http://specif.de/examples/02_Related-Terms.specif "SpecIF Example \'Related Terms\'") or work with it using the [SpecIF Editor](http://specif.de/apps/edit.html#import=../examples/02_Related-Terms.specif).
