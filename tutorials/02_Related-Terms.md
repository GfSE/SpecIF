...
- In the example, the statementCLass with \"id\":\"SC-isSpecialisationOf\" determines that all it's instance statements may only have resources with a resourceClass \"id\":\"RC-ResourceTerm\". In this case, there is just one instance with \"id\":\"S-X0lXi7lJP9DQs\", so it's subject and object must both be of type \"id\":\"RC-ResourceTerm\".
