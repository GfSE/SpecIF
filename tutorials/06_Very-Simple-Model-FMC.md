...
You may also view/download the example [Very Simple Model (FMC)](http://specif.de/examples/06_Very-Simple-Model-FMC.specifz "SpecIF Example \'Very Simple Model (FMC)\'") or view/edit it using the [SpecIF Editor](http://specif.de/apps/edit#import=../examples/06_Very-Simple-Model-FMC.specifz).
